...
CREATE TABLE PUBLISHER (PUB_ID INT NOT NULL, NAME VARCHAR(255) NOT NULL, PRIMARY KEY (PUB_ID));
CREATE TABLE AUTHOR (A_ID INT NOT NULL, NAME VARCHAR(255) NOT NULL, PRIMARY KEY (A_ID));
CREATE TABLE ITEM (ITEM_ID INT NOT NULL, NAME varchar(255) NOT NULL, AVAILABLE INT, LOCATIONCODE INT, LIBRARY_NAME varchar(255) NOT NULL, 
                   PUB_ID INT,
...
CREATE TABLE STUDENT (STUDENT_ID INT NOT NULL, NAME VARCHAR(255), FACULTY VARCHAR(255) NOT NULL, PHONE VARCHAR(255), USERNAME VARCHAR(255),
                        FOREIGN KEY (USERNAME) REFERENCES LOGIN(USERNAME),
...
CREATE TABLE FINE (FINE_ID INT NOT NULL, STUDENT_ID INT NOT NULL, ITEM_ID INT NOT NULL, AMOUNT INT, CHARGE_DATE DATE NOT NULL, PAY_DATE DATE,
                   FOREIGN KEY (STUDENT_ID) REFERENCES STUDENT(STUDENT_ID),
                   FOREIGN KEY (ITEM_ID) REFERENCES ITEM(ITEM_ID),
